...
public class LevenshteinWordDistance {
  ...
  public static void main(String[] args) throws IOException {
    final Path tess = Paths.get("E:/Masterarbeit/Ressourcen/DE-20__32_AM_49000_L869_G927-1/korrigiert/tess");
    final Path hand = Paths.get("E:/Masterarbeit/Ressourcen/DE-20__32_AM_49000_L869_G927-1/korrigiert/hand");
    ...
    final BufferedWriter writer = new BufferedWriter(
        new OutputStreamWriter(
            new FileOutputStream(
                "E:/Masterarbeit/Ressourcen/DE-20__32_AM_49000_L869_G927-1/korrigiert/word_comparison.txt"),
    ...
    for (Path handFile : handFiles) {
      ...
      charDist = distance(join(tessWords), join(handWords));

      sumWordDists += wordDist;
      sumCharDists += charDist;

      writer.write("word-dist = " + wordDist + ", char-dist = " + charDist
          + " (" + handFile.getFileName() + ")\n");
    }

    writer.write("total: word-dist = " + sumWordDists + ", char-dist = "
        + sumCharDists);
